...
// TODO try to find out existing library instead of creating your own...
public class JsonFileReader {
    ...
    public Object[][] readFile() {
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader(file))) {
            ...
            e.printStackTrace();
        } catch (IOException e) { //TODO Read IDEA warning !
            e.printStackTrace();
        }
    ...
    // TODO have you ever heard about code convention ?
